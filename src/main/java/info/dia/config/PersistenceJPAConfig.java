...
@ComponentScan({ "info.dia.persistence" })
@EnableJpaRepositories(basePackages = "info.dia.persistence.dao")
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "info.dia.persistence.model" });
